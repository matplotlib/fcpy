...
def get_config_from_root(root):
    ...
    version_file =  os.path.join('lib', 'fcpy', '_version.py')
    cfg.versionfile_source = get(parser, "versionfile_source") or version_file
    cfg.versionfile_build = get(parser, "versionfile_build") or os.path.join('fcpy', '_version.py')
    cfg.tag_prefix = get(parser, "tag_prefix") or 'v'
    cfg.parentdir_prefix = get(parser, "parentdir_prefix") or 'fcpy-'
